...
public class PanelInicial extends JPanel implements ActionListener {
	...
	/**
	 * Este m�todo se encarga de inicializar y modificar los botones del panel.
	 */
	public void ajustarBotones() {

		butIniciarSesion = new JButton("Iniciar Sesi�n");
		...
		butIniciarSesion.setToolTipText("�Ingresa con tu usuario y contrase�a para seguir con tu proceso!");
		...
		butCrearUsuario.setToolTipText("�Crea un nuevo usuario para completar el �lbum y mucho m�s!");

		butPartidaRapida = new JButton("Partida R�pida");
		...
		butPartidaRapida.setToolTipText("�Juega sin la necesidad de iniciar sesi�n o crear un usuario!");

	}

	/**
	 * Este m�todo se encarga de pintar las imagenes y gifs en el panel.
	 */
	@Override
	public void paintComponent(Graphics g) {
		...
		g.drawString("Parqu�s Mundial Rusia 2018", 460, 935);
	...
	/**
	 * Este m�todo se encarga de colocarle las acciones a los botones frente a un
	 * evento.
	 */
	@Override
