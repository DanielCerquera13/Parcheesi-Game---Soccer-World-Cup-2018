...
class CasillaSalidaTest extends TestCase implements Constantes{
	...
	public void escenario2() {
		...
		casillaSalida = new CasillaSalida(Constantes.SALIDA,1,  1);
		   ...
		   Ficha ficha1= new Ficha("colombia",  1); 
		   Ficha ficha2= new Ficha("colombia",  1); 
		   Ficha ficha3= new Ficha("colombia", 1); 
		   Ficha ficha4= new Ficha("colombia",  1); 
	...
	public void testAgregarFichaCorrectamente() {
		...
		escenario1(); 
		   ...
		   Ficha ficha1= new Ficha("colombia", 2); 
		   Ficha ficha2= new Ficha("colombia",  2); 
		   Ficha ficha3= new Ficha("colombia",  2); 
		   Ficha ficha4= new Ficha("colombia",  2); 
